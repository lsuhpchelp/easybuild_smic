...
# #
# 
# Modified by Le Yan, March 26, 2014
# Changed GENERAL_CLASS to an empty string
# Prevent the creation of the sym link of the module file
#
"""
...
#        for directory in [os.path.dirname(x) for x in [self.filename, classPathFile]]:
        for directory in [os.path.dirname(x) for x in [self.filename]]:
